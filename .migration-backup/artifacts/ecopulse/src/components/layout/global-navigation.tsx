          ...
          {showNav && (
            <header className="h-16 border-b border-zinc-100 bg-white flex items-center justify-between px-6 sticky top-0 z-30 shadow-sm">
              <div className="flex items-center gap-6">
                ...
                >
                  {isSidebarOpen ? <X className="h-6 w-6" aria-hidden="true" /> : <MoreHorizontal className="h-8 w-8" aria-hidden="true" />}
                </button>

                <div className="flex flex-col select-none">
                  <p className="text-xs font-black text-primary tracking-widest uppercase">EcoPulse AI</p>
