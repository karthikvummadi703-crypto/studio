        ...
        <CardContent className="p-10 pt-0 space-y-6">
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className={cn(
                    "h-12 pl-12 bg-zinc-50 border-zinc-200 rounded-xl focus-visible:ring-primary",
              ...
              {errors.fullName && (
                <p id="fullName-error" className="text-[10px] text-red-600 font-bold uppercase">
                  {errors.fullName}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {errors.email && (
                <p id="email-error" className="text-[10px] text-red-600 font-bold uppercase">
                  {errors.email}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {errors.password && (
                <p id="password-error" className="text-[10px] text-red-600 font-bold uppercase">
                  {errors.password}
                </p>
              )}
            </div>
            ...
            >
              {loading ? (
                <Spinner className="h-5 w-5" label="Registering environment node..." />
              ) : (
                "Register Node"
              )}
            </Button>
