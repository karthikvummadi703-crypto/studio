...
const EDUCATIONAL_TOPICS: EducationalTopic[] = [
  ...
  },
  {
    ...
    content:
      "Renewable energy comes from sources that replenish themselves naturally over short periods. This includes solar, wind, hydro, and geothermal energy. Transitioning to these sources is crucial for reducing carbon emissions and ensuring a sustainable energy future for the planet.",
    icon: Zap,
    category: "Energy",
    readTime: "6 min",
  ...
  },
  {
    ...
    content:
      "The zero-waste approach encourages the redesign of resource life cycles so that all products are reused. The goal is for no trash to be sent to landfills, incinerators, or the ocean. This involves the 5 Rs: Refuse, Reduce, Reuse, Recycle, and Rot (compost).",
    icon: Globe,
    category: "Waste",
    readTime: "7 min",
...
export default function KnowledgeHubPage() {
  ...
  const { data: rawRecords, isLoading: recordsLoading } = useCollection<CarbonRecord>(
    recordsQuery as unknown as import("firebase/firestore").Query<CarbonRecord> | null
  );
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {EDUCATIONAL_TOPICS.map((topic) => {
              ...
              return (
                <Card
                  key={topic.id}
                  className="bg-white border border-zinc-200 shadow-sm hover:shadow-md transition-all rounded-2xl overflow-hidden group"
                >
                  <div
                    className={`relative h-40 w-full bg-gradient-to-br ${topic.gradient} flex items-center justify-center`}
                  >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-xs font-bold text-primary">
                          {latestRecord.distance?.toFixed(1) ?? 0} km
                        </span>
                      </div>
                      <Progress
              ...
              <div className="space-y-6">
                <Card className="bg-zinc-900 text-white rounded-2xl p-8 border-none relative overflow-hidden shadow-xl">
                  ...
                  <Sparkles
                    className="absolute -bottom-6 -right-6 h-32 w-32 text-primary opacity-10"
                    aria-hidden="true"
                  />
                </Card>
              </div>
              ...
              <CardContent className="space-y-8 max-w-sm mx-auto">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-zinc-600 text-sm leading-relaxed font-medium">
                    Complete your first carbon impact audit to unlock hyper-personalized analysis
      ...
      <Dialog open={!!selectedTopic} onOpenChange={() => setSelectedTopic(null)}>
        <DialogContent className="max-w-2xl bg-white rounded-[2rem] border-none shadow-2xl p-0 overflow-hidden">
          {selectedTopic && (
            <div>
              <div
                className={`relative h-48 w-full bg-gradient-to-br ${selectedTopic.gradient} flex items-center justify-center`}
              >
              ...
              <div className="p-8 space-y-6">
                <DialogHeader>
                  <Badge
                    variant="outline"
                    className="w-fit text-primary border-primary/20 mb-2 uppercase tracking-widest text-xs font-bold"
                  >
