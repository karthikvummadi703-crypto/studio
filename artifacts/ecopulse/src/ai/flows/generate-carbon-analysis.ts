...
export const GenerateCarbonAnalysisInputSchema = z.object({
  ...
  totalEmissions: z.number().nonnegative().describe("Total carbon emissions in kgCO2e."),
...
const GenerateCarbonAnalysisOutputSchema = z.object({
  ...
  mainEmissionSources: z.array(z.string()).describe("Top 2–3 emission sources for this user."),
