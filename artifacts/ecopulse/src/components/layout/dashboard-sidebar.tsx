...
import { LayoutDashboard, Calculator, BookOpen, User, Leaf, X, Sparkles } from "lucide-react";
    ...
    <aside className="w-64 border-r border-black/5 flex flex-col h-screen bg-white">
      <div className="p-8 flex items-center justify-between">
        ...
        >
          ...
          <span className="font-headline font-bold text-lg tracking-[0.1em] text-foreground uppercase">
            ECOPULSE AI
          </span>
        </Link>
        <button
            ...
            >
              <item.icon
                className={cn(
                  ...
                  isActive ? "text-white" : "text-zinc-500/40"
                )}
              />
              <span>{item.name}</span>
            </Link>
