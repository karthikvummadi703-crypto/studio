...
export default function AreaChartComponent({ data }: AreaChartComponentProps) {
  ...
  return (
    <figure role="img" aria-label="Carbon emissions over time chart" className="h-[400px] w-full">
      <figcaption className="sr-only">
        A line chart showing your carbon emissions trend. Latest value: {latestValue} kgCO2e.
        Target: 1.5 kgCO2e.
      </figcaption>
